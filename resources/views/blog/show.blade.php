      ...
      <div class="container text-center">
        ...
        <div class="row h-100">
          <div class="col-lg-8 mx-auto align-self-center">
            ...
            <p class="opacity-70 text-uppercase small ls-1">{{ $post->name  }}</p>
            ...
            <p><img class="avatar avatar-sm" src="{{Auth::user()->gravatar}}" alt="..."></p>
            {{-- {{ Gravatar::src($post->user['email']) }} --}}
...
<script>
    ...
    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
    ...
    s.src = 'https://cms-x8ee3m8hk5.disqus.com/embed.js';
